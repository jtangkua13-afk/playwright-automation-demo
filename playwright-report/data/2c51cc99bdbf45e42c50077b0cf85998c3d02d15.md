...
- Name: cart.spec.ts >> Cart Tests >> Add product to cart
...
Call log:
  ...
  - waiting for getByText('Added!')
    7 × locator resolved to <h4 class="modal-title w-100">Added!</h4>
